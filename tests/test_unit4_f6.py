...
def test_unit4_f6_content_and_runtime_lock():
    ...
    candidates=[ROOT/'content/ap-biology/unit-7/content-lock-f6.json',ROOT/'content/ap-biology/unit-6/content-lock-f6.json',ROOT/'content/ap-biology/unit-5/content-lock-f6.json']
